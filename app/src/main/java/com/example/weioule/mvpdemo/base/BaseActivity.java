 ...
 * Date on 2018/10/29.
 */
public abstract class BaseActivity<B extends ViewDataBinding,P extends BasePresenter> extends AppCompatActivity implements IView {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mPresenter.mContext = this.getContexts().getApplicationContext();
