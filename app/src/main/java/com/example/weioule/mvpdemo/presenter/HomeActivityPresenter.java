...
import com.example.weioule.mvpdemo.activity.HomeActivity;
 ...
 * Date on 2018/10/29.
 */
public class HomeActivityPresenter extends BasePresenter<HomeActivity, HomeActivityModel> implements Callback {
